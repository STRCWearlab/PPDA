...
from scripts.utils import run_test_analysis, wandb_logging, eval_model, eval_one_epoch, train_one_epoch, train_one_epoch_phase1
...
if __name__ == "__main__":
    ...
    WANDB_PROJECT = "simuaug_mmfit_n_sub_ebl"
    WANDB_ENTITY = os.environ.get("WANDB_ENTITY", "SPECIFY_YOUR_WANDB_ENTITY")
    randint = random.randint(0, 1000)

    WANDB_RUN_NAME = f"mmfit_stda_{config['n_sub']}_{config['comb_idx']}_{randint}"

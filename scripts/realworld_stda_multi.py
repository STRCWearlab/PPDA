...
from scripts.utils import run_test_analysis, wandb_logging, eval_model, eval_one_epoch, train_one_epoch_phase1
...
if __name__ == "__main__":
    ...
    WANDB_RUN_NAME = f"realworld_stda_{config['n_sub']}_{config['comb_idx']}_{randint}"
